...
namespace MyLibrary.Controllers
{
    public class SeriesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("CountOfBooks,Id,Name,GenreId,Width,Heigt,ShlfId")] Serie serie)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("CountOfBooks,Id,Name,GenreId,Width,Heigt,ShlfId")] Serie serie)
        {
            if (id != serie.Id)
            {
                return NotFound();
