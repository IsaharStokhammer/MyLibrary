...
namespace MyLibrary.Controllers
{
    public class ShelvesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Width,WidthLeft,Height")] Shelf shelf)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Width,WidthLeft,Height")] Shelf shelf)
        {
            if (id != shelf.Id)
            {
                return NotFound();
